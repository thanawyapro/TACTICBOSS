...
describe('V131.4 game DNA and clean product language', () => {
  it('removes the retired smart-chat experience and AI-facing brand text', () => {
    ...
    expect(indexHtml).not.toContain('Tactic Boss AI');
    expect(indexHtml).toContain('<title>Tactic Boss — Football Tactical Coach</title>');
    expect(manifest).not.toContain('Tactic Boss AI');
