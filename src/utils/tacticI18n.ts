...
const termMap: Record<string, Partial<Record<SupportedLang,string>>> = {
  'Inverted Fullback': {ar:'ظهير وهمي',es:'Inverted Fullback',fr:'Inverted Fullback'},
  'Holding CDM': {ar:'محور دفاعي ثابت',es:'Holding CDM',fr:'Holding CDM'},
  'Shadow Striker': {ar:'مهاجم ظل',es:'Shadow Striker',fr:'Shadow Striker'},
  'CAM Playmaker': {ar:'صانع لعب',es:'CAM Playmaker',fr:'CAM Playmaker'},
  'Mid Block': {ar:'كتلة دفاعية متوسطة',es:'Mid Block',fr:'Mid Block'},
  'Low Block': {ar:'دفاع متأخر',es:'Low Block',fr:'Low Block'},
  'High Depth Press': {ar:'ضغط بخط دفاع متقدم',es:'High Depth Press',fr:'High Depth Press'},
  'Maintain Formation': {ar:'الحفاظ على التشكيل',es:'Maintain Formation',fr:'Maintain Formation'},
  'Frontline Pressure': {ar:'ضغط أمامي',es:'Frontline Pressure',fr:'Frontline Pressure'},
  'Long Pass': {ar:'تمرير طويل',es:'Long Pass',fr:'Long Pass'},
  'Short Pass': {ar:'تمرير قصير',es:'Short Pass',fr:'Short Pass'},
  'Counter Attack': {ar:'هجمة مرتدة',es:'Counter Attack',fr:'Counter Attack'},
  'Long Ball': {ar:'كرات طويلة',es:'Long Ball',fr:'Long Ball'},
  'Possession Game': {ar:'لعب استحواذ',es:'Possession Game',fr:'Possession Game'},
  'Balanced': {ar:'متوازن',es:'Equilibrado',fr:'Équilibré'},
  'Possession': {ar:'استحواذ',es:'Posesión',fr:'Possession'},
  'Quick Counter': {ar:'هجمة مرتدة سريعة',es:'Contraataque rápido',fr:'Contre-attaque rapide'},
  'Long Ball Counter': {ar:'هجمة مرتدة بكرات طويلة',es:'Contraataque con balón largo',fr:'Contre au ballon long'},
  'Out Wide': {ar:'اللعب على الأطراف',es:'Juego por bandas',fr:'Jeu sur les ailes'},
  'High Press': {ar:'ضغط عالٍ',es:'Presión alta',fr:'Pressing haut'},
  'Direct Passing': {ar:'تمرير مباشر',es:'Pase directo',fr:'Passes directes'},
  'Fast Build Up': {ar:'بناء سريع',es:'Construcción rápida',fr:'Construction rapide'},
  'All-out Defence': {ar:'دفاع متأخر',es:'Defensa total',fr:'Défense totale'},
  'Aggressive': {ar:'عدواني',es:'Agresivo',fr:'Agressif'},
  'Conservative': {ar:'محافظ',es:'Conservador',fr:'Prudent'},
  'Middle': {ar:'العمق',es:'Centro',fr:'Axe'},
  'Wide': {ar:'الأطراف',es:'Bandas',fr:'Largeur'},
  'Short-pass': {ar:'تمرير قصير',es:'Pase corto',fr:'Passe courte'},
  'Flexible': {ar:'مرن',es:'Flexible',fr:'Flexible'},
  ...
  'Centre': {ar:'العمق',es:'Centro',fr:'Axe'},
...
const optionLabels: Record<string, Record<SupportedLang,string>> = {
  ...
  'Possession Game':{ar:'لعب استحواذ',en:'Possession Game',es:'Juego de posesión',fr:'Jeu de possession'},
  'Counter Attack':{ar:'هجمة مرتدة',en:'Counter Attack',es:'Contraataque',fr:'Contre-attaque'},
  'Quick Counter':{ar:'هجمة مرتدة سريعة',en:'Quick Counter',es:'Contra rápida',fr:'Contre rapide'},
  'Long Ball Counter':{ar:'هجمة مرتدة بكرات طويلة',en:'Long Ball Counter',es:'Contra de balón largo',fr:'Contre par longs ballons'},
  'Out Wide':{ar:'اللعب على الأطراف',en:'Out Wide',es:'Juego por bandas',fr:'Jeu sur les ailes'},
  'Long Ball':{ar:'كرات طويلة',en:'Long Ball',es:'Balón largo',fr:'Long ballon'},
  'Short Pass':{ar:'تمرير قصير',en:'Short Pass',es:'Pase corto',fr:'Passe courte'},
  'Long Pass':{ar:'تمرير طويل',en:'Long Pass',es:'Pase largo',fr:'Passe longue'},
  'Frontline Pressure':{ar:'ضغط أمامي',en:'Frontline Pressure',es:'Presión adelantada',fr:'Pressing avancé'},
  'All-out Defence':{ar:'دفاع متأخر',en:'All-out Defence',es:'Defensa total',fr:'Défense totale'},
  'Center':{ar:'العمق',en:'Center',es:'Centro',fr:'Axe'},
  'Wide':{ar:'الأطراف',en:'Wide',es:'Bandas',fr:'Ailes'}
};
